...
var TweetsService = /** @class */ (function () {
    function TweetsService(repository) {
        this.repository = repository;
    }
    TweetsService.prototype.createTweet = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var content, userId, tweet;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        content = params.content, userId = params.userId;
                        return [4 /*yield*/, this.repository.createTweet({
                                data: {
                                    content: content,
                                    user: {
                                        connect: {
    ...
    TweetsService.prototype.getTweets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getTweets({})];
                    case 1:
                        tweets = _a.sent();
